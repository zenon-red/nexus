...
import { KeyFile } from "../../src/wallet/keyFile.js";
...
describe("KeyFile", () => {
    ...
    describe("Encrypt", () => {
        it("should encrypt correct 24 word mnemonic", async () => {
            const password = "password";
        ...
        // it("should encrypt correct 12 word mnemonic", async () => {
        //     const password = "password";
        //     const initialEntropy = "bbefd88e1ff3f673d24da98b51f04ee7";
        //     const keyStore = KeyStore.fromEntropy(initialEntropy);
        //     const json = await KeyFile.setPassword(password).encrypt(keyStore);
        //
        //     const store = await KeyFile.setPassword(password).decrypt(json);
