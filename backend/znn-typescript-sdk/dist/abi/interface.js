...
import { arrayify, concat, hexDataSlice, hexlify, hexZeroPad, isHexString } from "../utilities/bytes.js";
...
import { checkResultErrors } from "./coders/abstract-coder.js";
import { ConstructorFragment, EventFragment, FormatTypes, Fragment, FunctionFragment, ParamType } from "./fragments.js";
...
export class Interface {
    ...
    static getSighash(fragment) {
        return hexDataSlice(Hash.id(fragment.format()), 0, 4);
    }
    ...
    encodeFilterTopics(eventFragment, values) {
        ...
        const encodeTopic = (param, value) => {
            if (param.type === "string") {
                ...
                return Crypto.keccak256(hexlify(value));
            }
    ...
    encodeEventLog(eventFragment, values) {
        ...
        if (values.length !== eventFragment.inputs.length) {
            throw new Error("event arguments/values mismatch");
        }
        eventFragment.inputs.forEach((param, index) => {
            ...
            if (param.indexed) {
                if (param.type === "string") {
                    ...
                    topics.push(Crypto.keccak256(value));
                }
