import { BytesLike, arrayify } from "./bytes.js";
...
function getUtf8CodePoints(bytes: BytesLike, onError?: Utf8ErrorFunc): Array<number> {
    ...
    while(i < bytes.length) {
        ...
        let extraLength = null as any;
        let overlongMask = null as any;
...
export function toUtf8Bytes(str: string, form: UnicodeNormalizationForm = UnicodeNormalizationForm.current): Uint8Array {
    ...
    if (form != UnicodeNormalizationForm.current) {
        try {
            ...
            return logger.throwError("platform missing String.prototype.normalize", Logger.errors.UNSUPPORTED_OPERATION, {
