...
const tablesSchema = __schema({
  ...
  discovered_tasks: __table({
    ...
    indexes: [
      { name: 'by_created_at', algorithm: 'btree', columns: [
        'createdAt',
      ] },
      { name: 'id', algorithm: 'btree', columns: [
        'id',
      ] },
      { name: 'by_priority', algorithm: 'btree', columns: [
        'priority',
      ] },
  ...
  messages: __table({
    name: 'messages',
    indexes: [
      { name: 'by_channel', algorithm: 'btree', columns: [
        'channelId',
        'createdAt',
      ] },
      { name: 'id', algorithm: 'btree', columns: [
  ...
  project_messages: __table({
    ...
    indexes: [
      ...
      { name: 'by_project', algorithm: 'btree', columns: [
        'projectId',
      ] },
    ],
    constraints: [
  ...
  projects: __table({
    ...
    indexes: [
      ...
      { name: 'by_source_idea_id', algorithm: 'btree', columns: [
        'sourceIdeaId',
      ] },
    ],
    constraints: [
  ...
  task_dependencies: __table({
    ...
    indexes: [
      { name: 'by_depends_on_id', algorithm: 'btree', columns: [
        'dependsOnId',
      ] },
      { name: 'id', algorithm: 'btree', columns: [
        'id',
      ] },
      { name: 'by_task_id', algorithm: 'btree', columns: [
        'taskId',
      ] },
    ],
    constraints: [
  ...
  tasks: __table({
    name: 'tasks',
    indexes: [
      { name: 'by_assigned_to', algorithm: 'btree', columns: [
        'assignedTo',
      ] },
      { name: 'id', algorithm: 'btree', columns: [
        'id',
      ...
      { name: 'by_project_id', algorithm: 'btree', columns: [
        'projectId',
      ] },
      { name: 'by_status', algorithm: 'btree', columns: [
        'status',
  ...
  votes: __table({
    ...
    indexes: [
      ...
      { name: 'by_idea_agent', algorithm: 'btree', columns: [
        'ideaId',
        'agentId',
      ] },
    ],
